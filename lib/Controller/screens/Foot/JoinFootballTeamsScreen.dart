                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image:
                                          NetworkImage(teams[index].picture!))),
                                ),
                                SizedBox(width: 20,),
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      teams[index].players.length.toString()+"/15",
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                            ...
                            child: Row(
                              children: [
                                Column(
                                  children: [
                                    Text(
                                      "Team's Slogan !" , style: TextStyle(color: Colors.green,
                                        fontSize: 16,fontWeight: FontWeight.w500
                                    ),
                                    ),
                                    Text(
                                      teams[index].name!,style: TextStyle(
                                        fontSize: 16,fontWeight: FontWeight.w500
                                    ),
                                    ),Text(
                                      "Approved by Sportpall  ",style: TextStyle(color: Colors.indigoAccent,
                                        fontSize: 16,fontWeight: FontWeight.w500
                                    ),
                                    )
                                  ],
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                     ...
                                     var sendRequest = await NotificationService().joinRequest(id,teams[index].captain!.id! );
                                     print("ena id "+sendRequest.toString());
                                     print("ena id "+teams[index].captain!.id!.toString());
