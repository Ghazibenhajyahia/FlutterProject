...
class _UserCardWidgetState extends State<UserCardWidget> {
  ...
  Future<bool> fetchComplexe() async {
    ...
    if (ageConnected.isNotEmpty) {
      ageNowConnected = DateTime.parse(ageConnected);
    }
  ...
  Widget _buildCard(String name, String description, String imgPath,) {
    return Padding(
        padding: EdgeInsets.only(top: 5.0, bottom: 5.0, left: 5.0, right: 5.0),
        child: InkWell(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => AboutMeScreen(fullName:name ,profilePic:imgPath ,birthDate: description)));
            },
            child: Container(
                height: 250,
                width: 120,
