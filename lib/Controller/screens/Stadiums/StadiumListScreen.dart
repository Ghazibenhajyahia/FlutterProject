            ...
            return Column(
              children: [
                ...
                onTap: ()async {
                  ...
                  child: StadiumCard(title: widget.terrains[index].name!
                    ,description: widget.terrains[index].name!,imageUrl: widget.terrains[index].picture!
                    ,rating:  widget.terrains[index].rating!.toString(),),
                ),
                SizedBox(height: 10,),
              ],
            );
