...
class TennisMatchCard extends StatefulWidget {
  const TennisMatchCard({Key? key,required this.match}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        InkWell(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) => MatchHistoryDetailTennis(match: widget.match,)));
          },
          child: Container(
            height: 151,
