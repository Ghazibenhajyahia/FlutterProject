...
class _TinderCardState extends State<TinderCard> {
  ...
  buildCard() {
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context) => AboutMeScreen(fullName:widget.user!.name ,profilePic:widget.user!.urlImage ,birthDate: widget.user!.age,)));
      },
      child: ClipRRect(
