...
class _TournementScreenListState extends State<TournementScreenList> {
  ...
  Future<bool> fetchUser() async {
    await TournamentService().getTournament(tournament);
    print(tournament);
    setState(() {
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => TournamentDetailsScreen(tournement: tournament[index])));
                          },
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "In " +
                                              ...
                                              tournament[index].typeSport.toString(),
                                          textAlign: TextAlign.center,
                                          style: TextStyle(
                                              fontSize: 24,
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              /*  'from : ' +
                                                    tournament[index]
                                                        .from.toString() + "   to  " + tournament[index].to.toString()*/
                                                tournament[index].prize.toString(),
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  color: Colors.blue,
