...
class Notification {
  ...
  factory Notification.fromJson(dynamic json) {
    return Notification(json['_id'] as String?,json['from'] as Player?, json['to'] as List<Player?>, json['description'] as String?,json['date'] as String?, json['sent'] as bool?,json['accept'] as bool,json['type'] as String?,json['terrain'] as String?);
  }
